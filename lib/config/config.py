...
#FLAGS为一个类
FLAGS2 = {}
#FLAGS2为字典，FLAGS2={pixel_means': array([[[102.9801, 115.9465, 122.7717]]]), 
#                     'scales': (600,), 'test_scales': (600,), 'bbox_inside_weights': (1.0, 1.0, 1.0, 1.0), 'bbox_normalize_means': (0.0, 0.0, 0.0, 0.0), 'bbox_normalize_stds': (0.1, 0.1, 0.1, 0.1), 
...
#tf.app.flags.DEFINE_xxx(1, 2, 3): 1是参数名称，2是参数默认值，3是参数描述
